...
export const uploadRoom = (variables: IUploadRoomVariables) =>
  instance.post('rooms/', variables, { headers: { 'X-CSRFToken': Cookie.get('csrftoken') || '' } }).then((response) => response.data);

export const getUploadURL = () =>
  instance.post('medias/photos/get-url', null, { headers: { 'X-CSRFToken': Cookie.get('csrftoken') || '' } }).then((response) => response.data);
